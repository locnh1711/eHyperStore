    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "HomeTitle", "This is home page of eHyperStore" },
                    { "HomeKeyword", "This is keyword of eHyperStore" },
                    { "HomeDescription", "This is description of eHyperStore" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "vi", "Giày nam", "giay-nam", "Sản phẩm giày thời trang nam", "Sản phẩm giày thời trang nam" },
                    { 3, 2, "vi", "Giày nữ", "giay-nu", "Sản phẩm giày thời trang nữ", "Sản phẩm giày thời trang nữ" },
                    { 2, 1, "en", "Men Shoes", "men-shoes", "Men's fashion shoes", "Men's fashion shoes" },
                    { 4, 2, "en", "Women Shoes", "women-shoes", "Women's fashion shoes", "Women's fashion shoes" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Giày thể thao nam Nike", "Giày thể thao nam Nike", "vi", "Giày thể thao nam Nike", 1, "giay-the-thao-nam-nike", "Giày thể thao nam Nike", "Giày thể thao nam Nike" },
                    { 2, "Nike Men's Sports Shoes", "Nike Men's Sports Shoes", "en", "Nike Men's Sports Shoes", 1, "nike-men-sport-shoes", "Nike Men's Sports Shoes", "Nike Men's Sports Shoes" }
                });
