...
using eHyperStore.Utilities.Exceptions;
...
namespace eHyperStore.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public ProductService(EHyperDbContext context, IStorageService storageService)
        {
            _context = context;
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new EHyperException($"Cannot find a product: {productId}");
        ...
        public async Task<ProductVm> GetById(int productId, string languageId)
        {
            ...
            var productViewModel = new ProductVm()
            {
                ...
                ThumbnailImage = image != null ? image.ImagePath : "no-image.file"
            };
        ...
        public async Task<ProductImageViewModel> GetImageById(int imageId)
        {
            ...
            if (image == null)
                throw new EHyperException($"Cannot find an image with id {imageId}");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new EHyperException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new EHyperException($"Cannot find a product with id: {productId}");
        ...
        public async Task<ApiResult<bool>> CategoryAssign(int id, CategoryAssignRequest request)
        {
            ...
            if (user == null)
            {
                return new ApiErrorResult<bool>($"Products with unrecognized id {id}");
            }
